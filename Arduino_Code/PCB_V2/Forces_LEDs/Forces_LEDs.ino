...
void loop() {
  ...
  // LED control logic based on each channel’s force
  digitalWrite(ledPins[0], forces[0] > 2.5 ? HIGH : LOW); // A0
  digitalWrite(ledPins[1], forces[1] > 2.5 ? HIGH : LOW); // A3
  digitalWrite(ledPins[2], forces[2] > 2.5 ? HIGH : LOW); // A6
  digitalWrite(ledPins[3], forces[3] > 2.5 ? HIGH : LOW); // A9
  digitalWrite(ledPins[4], forces[4] > 4.5 ? HIGH : LOW); // A10
  digitalWrite(ledPins[5], forces[5] > 4.5 ? HIGH : LOW); // A11
  digitalWrite(ledPins[6], forces[6] > 4.5 ? HIGH : LOW); // A12
